System.register(['@angular/core', '@angular/platform-browser', './app.component', './media-item.component', './media-item-list.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, platform_browser_1, app_component_1, media_item_component_1, media_item_list_component_1;
    var AppModule;
    return {
        setters:[
            function (core_1_1) {
